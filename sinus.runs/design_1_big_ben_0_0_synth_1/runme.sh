...
HD_PWD='E:/Development/sinus_v2/sinus_v2/sinus.runs/design_1_big_ben_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_big_ben_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_big_ben_0_0.tcl
